...
const Usertable = () => {
  ...
  const navigateToNewmedicalbill = () => {
    navigate(`/user/NewMedicalBill?username=${username}`);
  };

  const navigateToShowbill = () => {
    navigate(`/user/showuserbill?username=${username}`);
  };
      ...
      <div className="sidebar">
        <ul className="nav flex-column">
          ...
          <li className="nav-item">
            <button className="nav-link" onClick={navigateToNewmedicalbill}>
              New Medical Bill
            </button>
          </li>
          <li className="nav-item">
            <button className="nav-link" onClick={navigateToShowbill}>
              Show Bill
            </button>
          </li>
          <li className="nav-item">
